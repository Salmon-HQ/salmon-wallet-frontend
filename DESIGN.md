...
There is no haptics in a browser. The press pulse and The Surfacing's success pulse have no equivalent: the visual channel ports whole and the tactile one simply does not exist on two of the three surfaces. Nothing replaces it — a visual stand-in for a haptic would be a second event of light, and there are exactly two.
