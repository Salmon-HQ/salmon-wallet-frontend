...
import { MIRROR_NETWORK_IDS, ensureMirrorNetworks, useAccountsContext } from '@salmon/shared';

/**
 * Completes an existing wallet's mirror (devnet / testnet / sepolia) addresses
 * the first time Developer Networks asks for them.
 *
...
export default useEnsureMirrorNetworks;
