  ...
  return (
    ...
    >
      {/*
        ...
        edge (safe area included) so no raw list row shows at pill level or
        in the gap under it; its densest stop is the water's own floor at
        just-under-full alpha, so it reads as depth, not a slab.
      */}
      <LinearGradient
      ...
      <View style={[styles.content, { paddingBottom: tabBarBottomPadding }]}>
        <View style={styles.glassContainer}>
          {/*
            ...
            because `membraneThin` guarantees `text.primary` alone (DESIGN.md
            §The scrim floor) and these labels wear secondary and salmon ink,
            which only `thick`'s worst-case composite carries. The tabBarFade
            gradient below is the material's own bottom edge and stays as it is.
          */}
          <Thermocline
            tier="thick"
