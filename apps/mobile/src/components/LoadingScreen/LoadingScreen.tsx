...
import { CRESTS, CREST_RASTER, MARK_SIZE } from './constants';
...
export function LoadingScreen({
  ...
  // Each tick fades the tip out on the UI thread and, once it is gone,
  // advances and fades the next one in. The clock is the shared `useWaitTips`.
  const onTipTick = useCallback(
    (advance: () => void) => {
