...
- **`getAuthContainerStyles(contained = true)`** (`common.ts:13-22`) describes a 380×min(760, 100vh−48) card that no caller currently requests. Either it is the extension's intended frame or it is dead.
