...
| 2                  | P2 token pass + new semantic groups (mobile-wide, excludes exchange/bridge/onboarding grid; SeedPhrase/QRScanner token substitution only) | expo-react-native-expert ×2 split by directory | `contrast.test.ts` pinned before/after     |
