...
| `scales`                                           | neutral strokes at α 0.03 | **coral**: `salmon-500` strokes at a low alpha over the flat light ground (owner, 2026-09-01: "probemos con las escamas color coral") | owner                                           |
| `flesh`, `water`, thermocline alphas               | —                         | re-tuned in a dedicated pass; first landing renders the light ground flat under the coral scales ⚠                                    | rule: rebuild, don't invert                     |
| salmon buttons (`accent.fill` + `accent.onFill`)   | invariant                 | invariant (owner: "los botones naranjas son los únicos que no deberían cambiar")                                                      | owner                                           |
